      ...
      <body>
        <div class="container">
          <div id="formSection">
            ...
            <p style="font-size: 12px; color: #666;">Chunk Size: 10MB (Stability Mode)</p>
            <form id="uploadForm">
  ...
  if (req.method === "POST" && url.pathname === "/upload") {
    try {
      ...
      const s3 = new S3Client({
        region: "sg", // Changed to 'sg' to match your zone
      ...
      const parallelUpload = new Upload({
        ...
        queueSize: 4, 
        partSize: 10 * 1024 * 1024, // Reduced to 10MB to fix ETag error
      });
